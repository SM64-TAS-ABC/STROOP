...
namespace STROOP.Structs.Configurations
{
    ...
    {
        public static uint AreaStartAddress { get => RomVersionConfig.Switch(AreaStartAddressUS, AreaStartAddressJP); }
        ...
        public static uint CurrentAreaPointerAddress { get => RomVersionConfig.Switch(CurrentAreaPointerAddressUS, CurrentAreaPointerAddressJP); }
