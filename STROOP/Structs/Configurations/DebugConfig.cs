...
namespace STROOP.Structs.Configurations
{
    ...
    {
        public static uint AdvancedModeAddress { get => RomVersionConfig.Switch(AdvancedModeAddressUS, AdvancedModeAddressJP); }
        public static readonly uint AdvancedModeAddressUS = 0x8033D263;
        public static readonly uint AdvancedModeAddressJP = 0x8033BEF3;

        public static uint AdvancedModeSettingAddress { get => RomVersionConfig.Switch(AdvancedModeSettingAddressUS, AdvancedModeSettingAddressJP); }
        ...
        public static uint ResourceMeterAddress { get => RomVersionConfig.Switch(ResourceMeterAddressUS, ResourceMeterAddressJP); }
        ...
        public static uint ResourceMeterSettingAddress { get => RomVersionConfig.Switch(ResourceMeterSettingAddressUS, ResourceMeterSettingAddressJP); }
        ...
        public static uint ClassicModeAddress { get => RomVersionConfig.Switch(ClassicModeAddressUS, ClassicModeAddressJP); }
        public static readonly uint ClassicModeAddressUS = 0x8032D598;
        public static readonly uint ClassicModeAddressJP = 0x8032C658;

        public static uint SpawnModeAddress { get => RomVersionConfig.Switch(SpawnModeAddressUS, SpawnModeAddressJP); }
        public static readonly uint SpawnModeAddressUS = 0x8033D2DF;
        public static readonly uint SpawnModeAddressJP = 0x8033BF6F;

        public static uint StageSelectAddress { get => RomVersionConfig.Switch(StageSelectAddressUS, StageSelectAddressJP); }
        public static readonly uint StageSelectAddressUS = 0x8032D58C;
        public static readonly uint StageSelectAddressJP = 0x8032C64C;

        public static uint FreeMovementAddress { get => RomVersionConfig.Switch(FreeMovementAddressUS, FreeMovementAddressJP); }
