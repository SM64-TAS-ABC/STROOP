...
namespace STROOP.Structs.Configurations
{
    ...
    {
        public static uint AdvancedModeAddress { get { return RomVersionConfig.Switch(AdvancedModeAddressUS, AdvancedModeAddressJP); } }
        public static readonly uint AdvancedModeAddressUS = 0x8033D263;
        public static readonly uint AdvancedModeAddressJP = 0x8033BEF3;

        public static uint AdvancedModeSettingAddress { get { return RomVersionConfig.Switch(AdvancedModeSettingAddressUS, AdvancedModeSettingAddressJP); } }
        ...
        public static uint ResourceMeterAddress { get { return RomVersionConfig.Switch(ResourceMeterAddressUS, ResourceMeterAddressJP); } }
        ...
        public static uint ResourceMeterSettingAddress { get { return RomVersionConfig.Switch(ResourceMeterSettingAddressUS, ResourceMeterSettingAddressJP); } }
        ...
        public static uint ClassicModeAddress { get { return RomVersionConfig.Switch(ClassicModeAddressUS, ClassicModeAddressJP); } }
        public static readonly uint ClassicModeAddressUS = 0x8032D598;
        public static readonly uint ClassicModeAddressJP = 0x8032C658;

        public static uint SpawnModeAddress { get { return RomVersionConfig.Switch(SpawnModeAddressUS, SpawnModeAddressJP); } }
        public static readonly uint SpawnModeAddressUS = 0x8033D2DF;
        public static readonly uint SpawnModeAddressJP = 0x8033BF6F;

        public static uint StageSelectAddress { get { return RomVersionConfig.Switch(StageSelectAddressUS, StageSelectAddressJP); } }
        public static readonly uint StageSelectAddressUS = 0x8032D58C;
        public static readonly uint StageSelectAddressJP = 0x8032C64C;

        public static uint FreeMovementAddress { get { return RomVersionConfig.Switch(FreeMovementAddressUS, FreeMovementAddressJP); } }
        public static readonly uint FreeMovementAddressUS = 0x80269BDA;
        public static readonly uint FreeMovementAddressJP = 0x8026976E;

        public static ushort FreeMovementOnValue { get { return RomVersionConfig.Switch(FreeMovementOnValueUS, FreeMovementOnValueJP); } }
        public static readonly ushort FreeMovementOnValueUS = 0x5FAB;
        public static readonly ushort FreeMovementOnValueJP = 0x5F0D;

        public static ushort FreeMovementOffValue { get { return RomVersionConfig.Switch(FreeMovementOffValueUS, FreeMovementOffValueJP); } }
