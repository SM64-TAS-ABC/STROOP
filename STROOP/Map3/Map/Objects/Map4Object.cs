...
namespace STROOP.Map3.Map
{
    ...
    {
        public Map4Tracker Tracker;

        /// <summary>
        /// List of graphics items for the object
        /// </summary>
        public abstract IEnumerable<Map4GraphicsItem> GraphicsItems { get; }
        ...
        {
            foreach (Map4GraphicsItem item in GraphicsItems)
            {
        ...
        public Map4Object(string name, Bitmap bitmapImage, Color? backColor, bool rotates, Color? color)
        {
            Name = name;
