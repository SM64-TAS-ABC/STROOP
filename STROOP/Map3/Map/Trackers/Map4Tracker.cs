...
namespace STROOP.Controls.Map.Trackers
{
    ...
    {
        private readonly Map4TrackerFlowLayoutPanel _flowLayoutPanel;
        public readonly List<Map4Object> MapObjectList;
        public readonly List<Map4Semaphore> SemaphoreList;
        ...
        public Map4Tracker(
            Map4TrackerFlowLayoutPanel flowLayoutPanel,
            List<Map4Object> mapObjectList,
            List<Map4Semaphore> semaphoreList)
        {
            InitializeComponent();

            _flowLayoutPanel = flowLayoutPanel;
            MapObjectList = new List<Map4Object>(mapObjectList);
            SemaphoreList = new List<Map4Semaphore>(semaphoreList);
