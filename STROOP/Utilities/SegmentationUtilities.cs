...
namespace STROOP.Structs
{
    public static class SegmentationUtilities
    {
        ...
        public static uint SegmentationTableAddressUS = 0x33B400;
        public static uint SegmentationTableAddressJP = 0x33A090;
        ...
        public static uint DecodeSegmentedAddress(uint segmentedAddress)
        {
            ...
            return offset + Config.Stream.GetUInt32(4 * segment + SegmentationTableAddress);
        }
    }
}
