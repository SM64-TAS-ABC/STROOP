...
namespace STROOP.Utilities
{
    public class PositionAngle
    {
            ...
            List<Func<double, bool>> setters = null)
        {
            ...
            bool shouldHaveThisAngle = PosAngleType == PositionAngleTypeEnum.Pos;
        ...
        public static PositionAngle FromString(string stringValue)
        {
            ...
            else if (parts.Count >= 1 && parts[0] == "pos")
            {
        ...
        private static double GetTriangleVertexComponent(uint address, int index, Coordinate coordinate)
        {
            ...
            switch (index)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    int closestVertexToMario = new TriangleDataModel(address).GetClosestVertex(
                        Mario.X, Mario.Y, Mario.Z);
                    return GetTriangleVertexComponent(address, closestVertexToMario, coordinate);
                case 5:
                    int closestVertexToSelf = new TriangleDataModel(address).GetClosestVertex(
                ...
                case 6:
                    switch (coordinate)
                    {
                        case Coordinate.X:
                            return Mario.X;
                        case Coordinate.Y:
                            return new TriangleDataModel(address).GetHeightOnTriangle(Mario.X, Mario.Z);
                        case Coordinate.Z:
                            return Mario.Z;
                        default:
                            throw new ArgumentOutOfRangeException();
