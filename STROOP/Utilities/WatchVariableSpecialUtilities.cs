...
namespace STROOP.Structs
{
    public static class WatchVariableSpecialUtilities
    {
            ...
            for (int i = 0; i < posAngleFuncs.Count; i++)
            {
                ...
                for (int j = 0; j < posAngleFuncs.Count; j++)
                {
                    ...
                    _dictionary[String.Format("Angle{0}To{1}", string1, string2)] =
                        ((uint address) =>
                        {
                            return PositionAngle.GetAngleTo(func1(address), func2(address), false, false);
                        },
                        (object objectValue, uint address) =>
                        {
                    ...
                    _dictionary[String.Format("DAngle{0}To{1}", string1, string2)] =
                        ((uint address) =>
                        {
                            return PositionAngle.GetDAngleTo(func1(address), func2(address), false);
                        },
                        (object objectValue, uint address) =>
                        {
        ...
        {
            _dictionary["MarioDistanceToObject"] =
                ((uint objAddress) =>
                {
            ...
            _dictionary["MarioHDistanceToObject"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position objPos = GetObjectPosition(objAddress);
            ...
            _dictionary["MarioXDistanceToObject"] =
                ((uint objAddress) =>
                {
            ...
            _dictionary["MarioYDistanceToObject"] =
                ((uint objAddress) =>
                {
            ...
            _dictionary["MarioZDistanceToObject"] =
                ((uint objAddress) =>
                {
            ...
            _dictionary["MarioDistanceToObjectHome"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
            ...
            _dictionary["MarioHDistanceToObjectHome"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position homePos = GetObjectHomePosition(objAddress);
            ...
            _dictionary["MarioXDistanceToObjectHome"] =
                ((uint objAddress) =>
                {
                    float marioX = Config.Stream.GetSingle(MarioConfig.StructAddress + MarioConfig.XOffset);
            ...
            _dictionary["MarioYDistanceToObjectHome"] =
                ((uint objAddress) =>
                {
                    float marioY = Config.Stream.GetSingle(MarioConfig.StructAddress + MarioConfig.YOffset);
            ...
            _dictionary["MarioZDistanceToObjectHome"] =
                ((uint objAddress) =>
                {
                    float marioZ = Config.Stream.GetSingle(MarioConfig.StructAddress + MarioConfig.ZOffset);
            ...
            _dictionary["ObjectDistanceToHome"] =
                ((uint objAddress) =>
                {
                    Position objPos = GetObjectPosition(objAddress);
                    Position homePos = GetObjectHomePosition(objAddress);
            ...
            _dictionary["ObjectHDistanceToHome"] =
                ((uint objAddress) =>
                {
                    Position objPos = GetObjectPosition(objAddress);
                    Position homePos = GetObjectHomePosition(objAddress);
            ...
            _dictionary["ObjectXDistanceToHome"] =
                ((uint objAddress) =>
                {
                    float objX = Config.Stream.GetSingle(objAddress + ObjectConfig.XOffset);
                    float homeX = Config.Stream.GetSingle(objAddress + ObjectConfig.HomeXOffset);
            ...
            _dictionary["ObjectYDistanceToHome"] =
                ((uint objAddress) =>
                {
                    float objY = Config.Stream.GetSingle(objAddress + ObjectConfig.YOffset);
                    float homeY = Config.Stream.GetSingle(objAddress + ObjectConfig.HomeYOffset);
            ...
            _dictionary["ObjectZDistanceToHome"] =
                ((uint objAddress) =>
                {
                    float objZ = Config.Stream.GetSingle(objAddress + ObjectConfig.ZOffset);
                    float homeZ = Config.Stream.GetSingle(objAddress + ObjectConfig.HomeZOffset);
            ...
            _dictionary["AngleObjectToMario"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position objPos = GetObjectPosition(objAddress);
            ...
            _dictionary["DeltaAngleObjectToMario"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position objPos = GetObjectPosition(objAddress);
            ...
            _dictionary["InGameAngleObjectToMario"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position objPos = GetObjectPosition(objAddress);
            ...
            _dictionary["InGameDeltaAngleObjectToMario"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position objPos = GetObjectPosition(objAddress);
            ...
            _dictionary["AngleMarioToObject"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position objPos = GetObjectPosition(objAddress);
            ...
            _dictionary["DeltaAngleMarioToObject"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position objPos = GetObjectPosition(objAddress);
            ...
            _dictionary["DeltaAngleObjectToHome"] =
                ((uint objAddress) =>
                {
                    Position objPos = GetObjectPosition(objAddress);
                    Position homePos = GetObjectHomePosition(objAddress);
            ...
            _dictionary["MarioGhostVerticalDistance"] =
                ((uint objAddress) =>
                {
                    float marioY = Config.Stream.GetSingle(MarioConfig.StructAddress + MarioConfig.YOffset);
            ...
            _dictionary["MarioGhostHorizontalDistance"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
            ...
            _dictionary["MarioGhostForwardsDistance"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position ghostPos = GetObjectGraphicsPosition(objAddress);
            ...
            _dictionary["MarioGhostSidewaysDistance"] =
                ((uint objAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position ghostPos = GetObjectGraphicsPosition(objAddress);
            ...
            _dictionary["MarioDistanceToHolp"] =
                ((uint dummy) =>
                {
                    Position marioPos = GetMarioPosition();
            ...
            _dictionary["MarioHDistanceToHolp"] =
                ((uint dummy) =>
                {
                    Position marioPos = GetMarioPosition();
                    Position holpPos = GetHolpPosition();
            ...
            _dictionary["CameraDistanceToMario"] =
                ((uint dummy) =>
                {
                    Position marioPos = GetMarioPosition();
            ...
            _dictionary["DeltaAngleMarioToV1"] =
                ((uint triAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    TriangleDataModel triStruct = Config.TriangleManager.GetTriangleStruct(triAddress);
            ...
            _dictionary["DeltaAngleMarioToV2"] =
                ((uint triAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    TriangleDataModel triStruct = Config.TriangleManager.GetTriangleStruct(triAddress);
            ...
            _dictionary["DeltaAngleMarioToV3"] =
                ((uint triAddress) =>
                {
                    Position marioPos = GetMarioPosition();
                    TriangleDataModel triStruct = Config.TriangleManager.GetTriangleStruct(triAddress);
            ...
            _dictionary["XDistanceSelfToPoint"] =
                ((uint dummy) =>
                {
            ...
            _dictionary["YDistanceSelfToPoint"] =
                ((uint dummy) =>
                {
            ...
            _dictionary["ZDistanceSelfToPoint"] =
                ((uint dummy) =>
                {
            ...
            _dictionary["HDistanceSelfToPoint"] =
                ((uint dummy) =>
                {
            ...
            _dictionary["DistanceSelfToPoint"] =
                ((uint dummy) =>
                {
            ...
            _dictionary["DeltaAngleSelfToPoint"] =
                ((uint dummy) =>
                {
            ...
            _dictionary["DeltaAnglePointToSelf"] =
                ((uint dummy) =>
                {
            ...
            _dictionary["DeltaAngleSelfToAngle"] =
                ((uint dummy) =>
                {
            ...
            _dictionary["DeltaAngleSelfToAngleTruncated"] =
                ((uint dummy) =>
                {
            ...
            _dictionary["FDistanceSelfToPoint"] =
                ((uint dummy) =>
                {
            ...
            _dictionary["SDistanceSelfToPoint"] =
                ((uint dummy) =>
                {
