...
{
    public static class WatchVariableSpecialUtilities2
    {
        ...
        public static (Func<uint, object> getter, Func<object, uint, bool> setter) CreateGetterSetterFunctionsUsingSwitchStatement(string specialType)
        {
