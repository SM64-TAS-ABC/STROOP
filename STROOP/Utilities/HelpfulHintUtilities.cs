    ...
    public static class HelpfulHintUtilities
    {
        private static readonly List<string> helpfulHints =
            new List<string>()
            {
                ...
                "Right click on the variable panel for options that affect all variables. You can save your changes to a tab's variables to keep it that way for next time.",
