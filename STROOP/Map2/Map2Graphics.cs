...
{
    public class Map2Graphics
    {
        int _mapTex = -1;
        int _mapBackgroundTex = -1;
        Size _mapImageSize;
        List<Map2BaseObject> _mapObjects = new List<Map2BaseObject>();
        ...
        public Map2Graphics(GLControl control)
        {
            Control = control;
        }
        ...
        public void AddMapObject(Map2BaseObject mapObj)
        {
            mapObj.Load(this);
            _mapObjects.Add(mapObj);
        }

        public void RemoveMapObject(Map2BaseObject mapObj)
        {
