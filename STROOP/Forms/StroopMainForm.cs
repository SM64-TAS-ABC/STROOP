    ...
    public partial class StroopMainForm : Form
    {
        ...
        private void CreateManagers()
        {
            Config.MapGui = new MapGui()
            {
                ...
                checkBoxMapOptionsTrackCamera = checkBoxMap3OptionsTrackCamera,
                checkBoxMapOptionsTrackFloorTri = checkBoxMap3OptionsTrackFloorTri,
                checkBoxMapOptionsTrackCeilingTri = checkBoxMap3OptionsTrackCeilingTri,
                checkBoxMapOptionsTrackCellGridlines = checkBoxMap3OptionsTrackCellGridlines,
                checkBoxMapOptionsTrackCurrentCell = checkBoxMap3OptionsTrackCurrentCell,
                checkBoxMapOptionsTrackUnitGridlines = checkBoxMap3OptionsTrackUnitGridlines,
                checkBoxMapOptionsTrackCurrentUnit = checkBoxMap3OptionsTrackCurrentUnit,
                checkBoxMapOptionsTrackNextPositions = checkBoxMap3OptionsTrackNextPositions,
                checkBoxMapOptionsTrackSelf = checkBoxMap3OptionsTrackSelf,
                checkBoxMapOptionsTrackPoint = checkBoxMap3OptionsTrackPoint,
                checkBoxMapOptionsEnable3D = checkBoxMap3OptionsEnable3D,
                checkBoxMapOptionsDisable3DHitboxHackTris = checkBoxMap3OptionsDisable3DHitboxHackTris,
                checkBoxMapOptionsEnablePuView = checkBoxMap3OptionsEnablePuView,
                checkBoxMapOptionsScaleIconSizes = checkBoxMap3OptionsScaleIconSizes,

                labelMapOptionsGlobalIconSize = labelMap3OptionsGlobalIconSize,
                textBoxMapOptionsGlobalIconSize = textBoxMap3OptionsGlobalIconSize,
                trackBarMapOptionsGlobalIconSize = trackBarMap3OptionsGlobalIconSize,

                buttonMapOptionsAddNewTracker = buttonMap3OptionsAddNewTracker,
                buttonMapOptionsClearAllTrackers = buttonMap3OptionsClearAllTrackers,
                buttonMapOptionsTrackAllObjects = buttonMap3OptionsTrackAllObjects,
                buttonMapOptionsTrackMarkedObjects = buttonMap3OptionsTrackMarkedObjects,

                comboBoxMapOptionsLevel = comboBoxMap3OptionsLevel,
                comboBoxMapOptionsBackground = comboBoxMap3OptionsBackground,

                groupBoxMapControllersScale = groupBoxMap3ControllersScale,
                groupBoxMapControllersCenter = groupBoxMap3ControllersCenter,
                groupBoxMapControllersAngle = groupBoxMap3ControllersAngle,

                radioButtonMapControllersScaleCourseDefault = radioButtonMap3ControllersScaleCourseDefault,
                radioButtonMapControllersScaleMaxCourseSize = radioButtonMap3ControllersScaleMaxCourseSize,
                radioButtonMapControllersScaleCustom = radioButtonMap3ControllersScaleCustom,
                textBoxMapControllersScaleCustom = textBoxMap3ControllersScaleCustom,

                textBoxMapControllersScaleChange = textBoxMap3ControllersScaleChange,
                buttonMapControllersScaleMinus = buttonMap3ControllersScaleMinus,
                buttonMapControllersScalePlus = buttonMap3ControllersScalePlus,
                textBoxMapControllersScaleChange2 = textBoxMap3ControllersScaleChange2,
                buttonMapControllersScaleDivide = buttonMap3ControllersScaleDivide,
                buttonMapControllersScaleTimes = buttonMap3ControllersScaleTimes,

                radioButtonMapControllersCenterBestFit = radioButtonMap3ControllersCenterBestFit,
                radioButtonMapControllersCenterOrigin = radioButtonMap3ControllersCenterOrigin,
                radioButtonMapControllersCenterMario = radioButtonMap3ControllersCenterMario,
                radioButtonMapControllersCenterCustom = radioButtonMap3ControllersCenterCustom,
                textBoxMapControllersCenterCustom = textBoxMap3ControllersCenterCustom,

                checkBoxMapControllersCenterChangeByPixels = checkBoxMap3ControllersCenterChangeByPixels,
                textBoxMapControllersCenterChange = textBoxMap3ControllersCenterChange,
                buttonMapControllersCenterUp = buttonMap3ControllersCenterUp,
                buttonMapControllersCenterUpRight = buttonMap3ControllersCenterUpRight,
                buttonMapControllersCenterRight = buttonMap3ControllersCenterRight,
                buttonMapControllersCenterDownRight = buttonMap3ControllersCenterDownRight,
                buttonMapControllersCenterDown = buttonMap3ControllersCenterDown,
                buttonMapControllersCenterDownLeft = buttonMap3ControllersCenterDownLeft,
                buttonMapControllersCenterLeft = buttonMap3ControllersCenterLeft,
                buttonMapControllersCenterUpLeft = buttonMap3ControllersCenterUpLeft,

                radioButtonMapControllersAngle0 = radioButtonMap3ControllersAngle0,
                radioButtonMapControllersAngle16384 = radioButtonMap3ControllersAngle16384,
                radioButtonMapControllersAngle32768 = radioButtonMap3ControllersAngle32768,
                radioButtonMapControllersAngle49152 = radioButtonMap3ControllersAngle49152,
                radioButtonMapControllersAngleMario = radioButtonMap3ControllersAngleMario,
                radioButtonMapControllersAngleCamera = radioButtonMap3ControllersAngleCamera,
                radioButtonMapControllersAngleCentripetal = radioButtonMap3ControllersAngleCentripetal,
                radioButtonMapControllersAngleCustom = radioButtonMap3ControllersAngleCustom,
                textBoxMapControllersAngleCustom = textBoxMap3ControllersAngleCustom,

                textBoxMapControllersAngleChange = textBoxMap3ControllersAngleChange,
                buttonMapControllersAngleCCW = buttonMap3ControllersAngleCCW,
                buttonMapControllersAngleCW = buttonMap3ControllersAngleCW,
