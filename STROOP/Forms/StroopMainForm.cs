...
namespace STROOP
{
    public partial class StroopMainForm : Form
    {
        ...
        private void CreateManagers()
        {
            ...
            // Create managers
            Config.MapManager = new MapManager(@"Config/MapVars.yml");

            Config.ModelManager = new ModelManager(tabPageModel);
            Config.ActionsManager = new ActionsManager(@"Config/ActionsData.yml", watchVariablePanelActions, tabPageActions);
            Config.WaterManager = new WaterManager(@"Config/WaterData.yml", watchVariablePanelWater);
            Config.SnowManager = new SnowManager(@"Config/SnowData.yml", watchVariablePanelSnow, tabPageSnow);
            Config.InputManager = new InputManager(@"Config/InputData.yml", tabPageInput, watchVariablePanelInput, _inputImageGuiList);
            Config.MarioManager = new MarioManager(@"Config/MarioData.yml", tabPageMario, WatchVariablePanelMario);
            Config.HudManager = new HudManager(@"Config/HudData.yml", tabPageHud, watchVariablePanelHud);
            Config.MiscManager = new MiscManager(@"Config/MiscData.yml", watchVariablePanelMisc, tabPageMisc);
            Config.CameraManager = new CameraManager(@"Config/CameraData.yml", tabPageCamera, watchVariablePanelCamera);
            Config.TriangleManager = new TriangleManager(tabPageTriangles, @"Config/TrianglesData.yml", watchVariablePanelTriangles);
            Config.DebugManager = new DebugManager(@"Config/DebugData.yml", tabPageDebug, watchVariablePanelDebug);
            Config.PuManager = new PuManager(@"Config/PuData.yml", tabPagePu, watchVariablePanelPu);
            Config.TasManager = new TasManager(@"Config/TasData.yml", tabPageTas, watchVariablePanelTas);
            Config.FileManager = new FileManager(@"Config/FileData.yml", tabPageFile, watchVariablePanelFile, _fileImageGui);
            Config.MainSaveManager = new MainSaveManager(@"Config/MainSaveData.yml", tabPageMainSave, watchVariablePanelMainSave);
            Config.AreaManager = new AreaManager(tabPageArea, @"Config/AreaData.yml", watchVariablePanelArea);
            Config.QuarterFrameManager = new QuarterFrameManager(@"Config/QuarterFrameData.yml", watchVariablePanelQuarterFrame);
            Config.CustomManager = new CustomManager(@"Config/CustomData.yml", tabPageCustom, watchVariablePanelCustom);
            Config.VarHackManager = new VarHackManager(tabPageVarHack, varHackPanel);
            Config.CamHackManager = new CamHackManager(@"Config/CamHackData.yml", tabPageCamHack, watchVariablePanelCamHack);
            Config.ObjectManager = new ObjectManager(@"Config/ObjectData.yml", tabPageObject, WatchVariablePanelObject);
            Config.OptionsManager = new OptionsManager(@"Config/OptionsData.yml", tabPageOptions, watchVariablePanelOptions, pictureBoxCog);
            Config.TestingManager = new TestingManager(tabPageTesting);
            Config.MemoryManager = new MemoryManager(tabPageMemory, watchVariablePanelMemory, @"Config/ObjectData.yml");
            Config.SearchManager = new SearchManager(tabPageSearch, watchVariablePanelSearch);
            Config.CellsManager = new CellsManager(@"Config/CellsData.yml", tabPageCells, watchVariablePanelCells);
            Config.CoinManager = new CoinManager(tabPageCoin);
            Config.GfxManager = new GfxManager(tabPageGfx, watchVariablePanelGfx);
            Config.PaintingManager = new PaintingManager(@"Config/PaintingData.yml", watchVariablePanelPainting, tabPagePainting);
            Config.MusicManager = new MusicManager(@"Config/MusicData2.yml", watchVariablePanelMusic, tabPageMusic);
            Config.ScriptManager = new ScriptManager(@"Config/ScriptData.yml", tabPageScript, watchVariablePanelScript);
            Config.SoundManager = new SoundManager(tabPageSound);
            Config.WarpManager = new WarpManager(@"Config/WarpData.yml", tabPageWarp, watchVariablePanelWarp);
        ...
        public void LoadConfig(MainLoadingForm loadingForm)
        {
            ...
            TableConfig.TriangleInfo = XmlConfigParser.OpenTriangleInfoTable(@"Config/TriangleInfo.yml");
            TableConfig.PendulumSwings = XmlConfigParser.OpenPendulumSwingTable(@"Config/PendulumSwings.xml");
            TableConfig.RacingPenguinWaypoints = XmlConfigParser.OpenWaypointTable(@"Config/RacingPenguinWaypoints.yml");
            TableConfig.KoopaTheQuick1Waypoints = XmlConfigParser.OpenWaypointTable(@"Config/KoopaTheQuick1Waypoints.yml");
            TableConfig.KoopaTheQuick2Waypoints = XmlConfigParser.OpenWaypointTable(@"Config/KoopaTheQuick2Waypoints.yml");
            TableConfig.TtmBowlingBallPoints = XmlConfigParser.OpenPointTable(@"Config/TtmBowlingBallPoints.yml");
