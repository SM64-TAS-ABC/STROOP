    ...
    public partial class StroopMainForm : Form
    {
        ...
        private void CreateManagers()
        {
            Config.MapGui = new MapGui()
            {
                ...
                checkBoxMapOptionsTrackCellGridlines = checkBoxMapOptionsTrackCellGridlines,
                checkBoxMapOptionsTrackCurrentCell = checkBoxMapOptionsTrackCurrentCell,
                checkBoxMapOptionsTrackUnitGridlines = checkBoxMapOptionsTrackUnitGridlines,
                checkBoxMapOptionsTrackCurrentUnit = checkBoxMapOptionsTrackCurrentUnit,
