...
namespace SM64_Diagnostic.Controls
{
    public class VarHackContainer : TableLayoutPanel
    {
        ...
        private PictureBox _lockPictureBox;
        private PictureBox _pinPictureBox;
        private TextBox _valueTextBox;
        private CheckBox _valueCheckBox;
        private ContextMenuStrip _valueTextboxOriginalContextMenuStrip;
        private ContextMenuStrip _nameTextboxOriginalContextMenuStrip;
        ...
        private PictureBox CreateLockPictureBox()
        {
            ...
            lockPictureBox.Location =
                new Point(_variableNameWidth - 10, _variableHeight / 2 - 9);
        ...
        private PictureBox CreatePinPictureBox()
        {
            ...
            lockPictureBox.Anchor = AnchorStyles.Right;
            lockPictureBox.Location =
                new Point(_variableNameWidth - 15, _variableHeight / 2 - 8);
            lockPictureBox.Visible = false;
            return lockPictureBox;
        }
